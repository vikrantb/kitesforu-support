...
|--------|---------|-------|
| [check] | Completed | Task finished successfully |
| [cycle] | In progress | Currently working |
| [wait] | Pending | Scheduled, not started |
| [alert] | Blocker/Urgent | Immediate attention needed |
| [search] | Investigating | Deep analysis mode |
| [idea] | Insight | Key discovery |
| [warn] | Warning | Needs review |
| [x] | Failed | Something broke |
